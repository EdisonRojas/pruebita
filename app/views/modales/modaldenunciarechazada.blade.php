        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="panel-title" id="contactLabel"><span class="glyphicon glyphicon-ok"></span> Anuncio sin problemas</h4>
            </div>
                ...
                <div class="modal-body" style="padding: 5px;">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <p>{{Auth::user()->nombres}}, después de la revisión has constatado que el anuncio no incumple ninguna norma de uso y deseas que el mismo pueda ser publicado nuevamente, presiona Activar </p>
                        </div>
                    </div>
                </div>  
