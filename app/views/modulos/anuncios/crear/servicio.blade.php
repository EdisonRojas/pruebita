...
<div class="contenedor-interno">
	...
	<div class="row">
	{{ Form::open(['route'=>'serviciocreado', 'method'=>'POST', 'role'=>'form','files' => true, 'novalidate']) }}		
		...
		<div class="col-xs-12  col-sm-offset-2 col-sm-8 col-md-offset-1 col-md-10  cabeza">
			...
			<input id="oculto" type="hidden" name="seccion_id" value=2><br>
			<input id="oculto" type="hidden" name="categoria_id" value={{ $categoria->id }}><br>
			<input id="oculto" type="hidden" name="subcategoria_id" value= {{ $subcategoria->id }}><br>
