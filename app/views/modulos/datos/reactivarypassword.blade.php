	...
	<div class="centrar-div">
	 ...
	 <div class="row">
        ...
        <div class="col-xs-12 col-sm-offset-4 col-sm-4">
            <h4 class="alert alert-info">Hola {{ $usuario->nombres }} ahora establece una nueva contraseña para poder usar con normalidad tu cuenta en miradita.</h4>
            {{ Form::open(['route'=>'nuevopassword', 'method'=>'POST', 'role'=>'form', 'novalidate']) }}	            	                
