        ...
        <div class="col-xs-12 col-sm-offset-4 col-sm-4">
            ...
            {{-- Form::model($usuario,['route'=>'edicioncuenta', 'method'=>'POST', 'role'=>'form', 'novalidate']) --}}	
            	<div class="form-group">
					...
					<p class="alert alert-info">Este correo se encuentra asociado a una red social con la que estás registrado en el sistema, por ello
					no puedes modificar tu correo electrónico.
					</p>	
