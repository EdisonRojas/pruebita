	...
	<div class="centrar-div">
	 ...
	 <div class="row">
        ...
        <div class="col-xs-12 col-sm-offset-4 col-sm-4">
            <p class="alert alert-info">Hola {{ $usuario->nombres }} por favor establece la nueva contraseña para poder acceder a tu cuenta en miradita.</p>
            {{ Form::open(['route'=>'password.nuevo', 'method'=>'POST', 'role'=>'form', 'novalidate']) }}	            	                
